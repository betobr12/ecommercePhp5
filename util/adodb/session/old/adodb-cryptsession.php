...
wrapper library.
 ...
 =======
	...
	include('../../../../admin/util/adodb/session/old/adodb.inc.php');
	#---------------------------------#
	include('../../../../admin/util/adodb/session/old/adodb-cryptsession.php'); 
	#---------------------------------#
	session_start();
...
include_once('../../../../admin/util/adodb/session/old/crypt.inc.php');
