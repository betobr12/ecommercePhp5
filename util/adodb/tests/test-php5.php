...
include("../../../admin/util/adodb/tests/adodb-exceptions.inc.php");
include("../../../admin/util/adodb/tests/adodb.inc.php");	
...
try {
	include_once("../../../admin/util/adodb/adodb-active-record.inc.php");
...
include_once("../../../admin/util/adodb/tests/test-active-record.php");
?>