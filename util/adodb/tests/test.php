...
if (PHP_VERSION < 5) include_once('../../../admin/util/adodb/adodb-pear.inc.php');
//--------------------------------------------------------------------------------------
...
global $ADODB_EXTENSION;
	...
	include_once('../../../admin/util/adodb/session/adodb-session.php');
...
*/
 ...
 //	$db->debug=true;
	...
	print "<p>Test CSV</p>";
	include_once('../../../admin/util/adodb/toexport.inc.php');
	//$ADODB_FETCH_MODE = ADODB_FETCH_ASSOC;
	...
	/////////////////////////////////////////////////////////////
	include_once('../../../admin/util/adodb/pivottable.inc.php');
	...
	include_once "../../../admin/util/adodb/tests/PEAR.php";
...
include("../../../admin/util/adodb/tohtml.inc.php");
include("../../../admin/util/adodb/adodb.inc.php");
include("../../../admin/util/adodb/rsfilter.inc.php");
...
Test <a href=../../../admin/util/adodb/tests/test4.php>GetInsertSQL/GetUpdateSQL</a> &nbsp; 
	<a href=../../../admin/util/adodb/tests/testsessions.php>Sessions</a> &nbsp;
	<a href=../../../admin/util/adodb/tests/testpaging.php>Paging</a> &nbsp;
	<a href=../../../admin/util/adodb/tests/test-perf.php>Perf Monitor</a><p>
<?php
include('../../../admin/util/adodb/tests/testdatabases.inc.php');

echo "<br>vers=",ADOConnection::Version();


include_once('../../../admin/util/adodb/adodb-time.inc.php');
