...
function tpear()
{
include_once('../../../admin/util/adodb/tests/DB.php');
...
function tadodb()
{
include_once('../../../admin/util/adodb/adodb.inc.php');
...
?>
<a href=../../../admin/util/adodb/tests/tmssql.php?do=tmssql>mssql</a>
<a href=../../../admin/util/adodb/tests/tmssql.php?do=tpear>pear</a>
<a href=../../../admin/util/adodb/tests/tmssql.php?do=tadodb>adodb</a>
<?php
if (!empty($_GET['do'])) {
	$do = $_GET['do'];
	switch($do) {
